...
TURN_STRENGTH_CAVEAT = "Near a coin flip: it reacts to the pattern of the words, not their meaning."
...
CARD_DISCLAIMER = (
    ...
    "Entertainment and research — not a forecast, not advice.",
)
...
def render_share_html(answer: dict, base_url: str) -> str:
    ...
    if election_embargo(answer):
        ...
        description = html.escape(
            ...
            "simulation. Entertainment and research, not a forecast and not advice."
        )
