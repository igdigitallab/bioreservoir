 ...
 *
 * 2026-09-22: added a direct "Source code on GitHub" link next to "Built by" — the repo link
 * on `/` previously only existed in index.html's JSON-LD (not visible to a human visitor);
 * /data and /press already link to it in their body text, this is the same link on every page. */
  ...
  return h(
    ...
    h("div", { class: "container" }, [
      ...
      h("p", { class: "footer-links" }, [
        ...
        h(
          "a",
          { href: "https://github.com/igdigitallab/bioreservoir", target: "_blank", rel: "noopener" },
