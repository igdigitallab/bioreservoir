...
// `?ref=fly` (not a utm_source, see src/analytics.ts): the one durable marker that this visitor
// came from BioReservoir, carried all the way to a lead without overwriting their real original
// source (Hacker News, Reddit, ...) the way a utm parameter on our own domain would have.
const COMPANY_URL = "https://igdigi.com/?ref=fly";
